defmodule Oasis.Parser.Metadata do
  ...
  @type http_method :: :post | :get | :delete | :head | :put | :connect | :options | :trace | :patch
  ...
  def new(schema, requires_auth, response_status_codes, uri_params, path, method) when is_boolean(requires_auth) and is_list(response_status_codes) and is_binary(path) and is_binary(method) do
      %__MODULE__{
        schema: schema,
